...
class AppConfigEnv:
    ...
    ais_log_file: str = field(default_factory=lambda: os.environ.get("AIS_LOG_DIRECTORY", "ais_processor.log"))
...
class AppConfigFile:
    ...
    def __init__(self, config_path: str):
        ...
        self.ais_log_file: str = self.get("AIS", "AIS_LOG_DIRECTORY", default="ais_processor.log")
